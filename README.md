...
- Para conocer los ejemplos de cadenas de Markov y checar su comportamiento, los scripts correspondientes son Caminata_A_Z.py, Coleccionista.py, Ehrenfest.py, N_ciclo.py, Polya.py, Ruina_del_jugador.py, Wright_Fisher.py y Galton_Watson.py. 
